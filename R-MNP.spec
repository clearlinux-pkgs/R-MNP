...
Version  : 3.1.2
Release  : 29
URL      : https://cran.r-project.org/src/contrib/MNP_3.1-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/MNP_3.1-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620920478
